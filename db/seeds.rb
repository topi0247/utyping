...
Lyric.find_or_create_by!(uid: 'Xgy7JzY1Gcg') do |lyric|
  ...
  lyric.data = [
    ...
    { time: 52, kanji: '君は飛び立つ', hiragana: 'きみはとびたつ' },
    { time: 64, kanji: '限りなく青い空に心ふるわせ', hiragana: 'かぎりなくあおいそらにこころふるわせ' },
    { time: 68, kanji: '自由をかける鳥よ', hiragana: 'じゆうをかけるとりよ' },
    { time: 75, kanji: '振り返ることもせず', hiragana: 'ふりかえることもせず' },
    { time: 80, kanji: '勇気を翼に込めて', hiragana: 'ゆうきをつばさにこめて' },
...
Lyric.find_or_create_by!(uid: 'DqBGL4SR9EA') do |lyric|
  ...
  lyric.data = [
    ...
    { time: 27, kanji: 'いつかも夕日がうつしだしたね', hiragana: 'いつかもゆうひがうつしだしたね' },
    { time: 34, kanji: 'さあ出かけよう', hiragana: 'さあでかけよう' },
...
Lyric.find_or_create_by!(uid: 'mLfew0H8IMw') do |lyric|
  ...
  lyric.data = [
    ...
    { time: 42, kanji: 'めぐる想いにのって', hiragana: 'めぐるおもいにのって' },
    { time: 55, kanji: 'ぼくらは時の時の旅人', hiragana: 'ぼくらはときのときのたびびと' },
    { time: 61, kanji: '忘れかけていた日々', hiragana: 'わすれかけていたひび' },
    { time: 71, kanji: 'すべてのものが友達だった頃', hiragana: 'すべてのものがともだちだったころ' },
    { time: 75, kanji: '汗をぬぐってあるいた道', hiragana: 'あせをぬぐってあるいたみち' },
    { time: 79, kanji: '野原で見つけた小さな花', hiragana: 'のはらでみつけたちいさなはな' },
    { time: 85, kanji: '幼い日の手のぬくもりが帰ってくる', hiragana: 'おさないひのてのぬくもりがかえってくる' },
    { time: 89, kanji: '汗をぬぐってあるいた道', hiragana: 'あせをぬぐってあるいたみち' },
    { time: 93, kanji: '野原で見つけた小さな花', hiragana: 'のはらでみつけたちいさなはな' },
    { time: 100, kanji: '幼い日のてのぬくもりが帰ってくる', hiragana: 'おさないひのてのぬくもりがかえってくる' },
    { time: 106, kanji: 'やさしい雨に打たれ', hiragana: 'やさしいあめにうたれ' },
    { time: 112, kanji: '緑がよみがえるように', hiragana: 'みどりがよみがえるように' },
    { time: 117, kanji: '涙のあとにはいつも君が', hiragana: 'なみだのあとにはいつもきみが' },
    { time: 123, kanji: 'そばにいて生きる喜び', hiragana: 'そばにいていきるよろこび' },
    { time: 129, kanji: 'おしえてくれた', hiragana: 'おしえてくれた' },
    { time: 135, kanji: 'おしえてくれた', hiragana: 'おしえてくれた' },
    { time: 146, kanji: '今、君と未来への扉開こう', hiragana: 'いま、きみとみらいへのとびらひらこう' },
    { time: 157, kanji: '今、君とあふれる希望をうたおう', hiragana: 'いま、きみとあふれるきぼうをうたおう' },
    { time: 142, kanji: 'めぐる風めぐる想いにのって', hiragana: 'めぐるかぜめぐるおもいにのって' },
    { time: 168, kanji: 'すばらしい明日に会いにゆこう', hiragana: 'すばらしいあしたにあいにゆこう' },
    { time: 174, kanji: 'めぐる風めぐる想いにのって', hiragana: 'めぐるかぜめぐるおもいにのって' },
